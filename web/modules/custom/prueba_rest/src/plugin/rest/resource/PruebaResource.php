 ...
 *
 * @RestResource (
 *   id = "prueba_rest_prueba",
 *   label = @Translation("prueba"),
 *   uri_paths = {
 *     "canonical" = "/api/prueba-rest-prueba",
 *     "create" = "/api/prueba-rest-prueba"
 *   }
 * )
 *
 * @DCG
 ...
 */
final class PruebaResource extends ResourceBase {
  ...
  public function post(array $data): ModifiedResourceResponse {
    ...
    $this->logger->notice('Created new prueba record @id.', ['@id' => $data['id']]);
  ...
  public function get() {
    ...
    $datas = \Drupal::service('fsfb_pac_user.avatarpool')->ListAvatar();

    $response = new CacheableJsonResponse($datas);
  ...
  public function patch($id, array $data): ModifiedResourceResponse {
    ...
    $this->logger->notice('The prueba record @id has been updated.', ['@id' => $id]);
